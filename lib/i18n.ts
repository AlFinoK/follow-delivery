...
export const translations: Record<Lang, Translations> = {
	ru: {
		...
		nmPending: 'Доставка пока не подтверждена — следите за статусом в списке отправок.',
	...
	kk: {
		...
		nmPending: 'Жеткізу әзірге расталған жоқ — күйін жіберулер тізімінен қадағалаңыз.',
